...
const AttackTrends = () => {
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-center h-64">
          ...
          <span className="ml-2 text-gray-600">Loading attack trends...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-gray-900">{trendsData.summary.total_attacks}</div>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-gray-900">{trendsData.summary.unique_attack_types}</div>
      ...
      {/* Main Trends Chart */}
      <div className="mb-6">
        <h4 className="text-md font-semibold text-gray-900 mb-4">Attack Volume Over Time</h4>
      ...
      {attackTypes.length > 0 && (
        <div className="mb-6">
          <h4 className="text-md font-semibold text-gray-900 mb-4">Attack Types Over Time</h4>
          <ResponsiveContainer width="100%" height={300}>
      ...
      {trendsData.summary.top_recent_attacks && trendsData.summary.top_recent_attacks.length > 0 && (
        <div>
          <h4 className="text-md font-semibold text-gray-900 mb-4">Most Active Attack Types</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {trendsData.summary.top_recent_attacks.map((attack, index) => (
              <div key={attack.type} className="border rounded-lg p-3">
                <div className="flex items-center justify-between">
